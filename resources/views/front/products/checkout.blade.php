                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="order-h6">GHC{{ $getDiscountAttributePrice['final_price'] * $item['quantity'] }}</h6> {{-- price of all products (after discount (if any)) (= price (after discoutn) * no. of products) --}}
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="order-h3">GHC{{ $total_price }}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            <span class="shipping_charges">GHC0</span>
                                                        </h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            ...
                                                            @if (\Illuminate\Support\Facades\Session::has('couponAmount')) {{-- We stored the 'couponAmount' in a Session Variable inside the applyCoupon() method in Front/ProductsController.php --}}
                                                                <span class="couponAmount">GHC{{ \Illuminate\Support\Facades\Session::get('couponAmount') }}</span>
                                                            @else
                                                                GHC0
                                                            @endif
                                                        </h6>
