    ...
    <div class="container">
                    ...
                    <div class="footer-list">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span>+233545819229</span>
                                </a>
                            </li>
                            <li>
                                <a href="mailto:info@localshop.com">
                                <i class="fas fa-envelope u-s-m-r-9"></i>
                                <span>
                                info@localshop.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="bottom-footer-wrapper">
            ...
            <p class="copyright-text">Copyright &copy; {{  date('Y') }}
                <a target="_blank" rel="nofollow" href="#">LocalShop Project Work</a> | All Right Reserved
            </p>
        </div>
    </div>
    <!-- Bottom-Footer /- -->
